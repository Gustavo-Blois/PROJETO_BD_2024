...
CONSTRAINT CK_CPF_PESSOA CHECK(REGEXP_LIKE(CPF, '[0-9]{3}\.[0-9]{3}\.[0-9]{3}\-[0-9]{2}'))
);
...
CONSTRAINT CK_NUM_TELEFONE_MENTOR CHECK(REGEXP_LIKE(NUM_TELEFONE, '\(\d{2}\)\d{5}-\d{4}')),
...
CREATE TABLE ATLETA(
PESSOA CHAR(14) NOT NULL,
CLUBE_OU_EQUIPE VARCHAR2(40) NOT NULL,
NOME VARCHAR2(100),
...
CONSTRAINT CK_NUM_TELEFONE_ATLETA CHECK(REGEXP_LIKE(NUM_TELEFONE, '\(\d{2}\)\d{5}-\d{4}')),
...
NOME_DO_ESPACO VARCHAR2(50) NOT NULL,
...
LOCAL_DE_TREINO VARCHAR2(50) NOT NULL,
...
DATA DATE NOT NULL,
TOPICO VARCHAR2(50),
EXERCICIO VARCHAR2(50),
ACOMPANHAMENTO_DE_PROGRESSO VARCHAR2(50),
LOCAL_DE_TREINO VARCHAR2(50) NOT NULL,
...
CREATE TABLE EVENTO(
NOME_DO_EVENTO VARCHAR2(50) NOT NULL,
...
NOME_DA_COMPETICAO VARCHAR2(50) NOT NULL,
